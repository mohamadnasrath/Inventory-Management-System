...
namespace nventory_Management_System
{
    public partial class CategoryModule : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Server=db48793.databaseasp.net; Database=db48793; User Id=db48793; Password=Lw8#5-xP=pQ2; Encrypt=False; MultipleActiveResultSets=True;");
